...
class AnimatedTransition {
  ...
  AnimatedTransition(Projection projection, ClusterPoint originClusterPoint,
      InputPoint firstRelevantInputPointFromOriginClusterPoint,
    ...
    this.originClusterRelevantInputPoints =
        new ClusterPoint(firstRelevantInputPointFromOriginClusterPoint, projection, true,
    ...
    this.spans180Meridian = Math.abs((originClusterPoint.getMapPosition().longitude)
        - (destinationClusterPoint.getMapPosition().longitude)) > 180;
  }
