...
class ClusterTransitions {
  ...
  static class Builder {
    ...
    private final ArrayList<AnimatedTransition> animatedTransitions =
        new ArrayList<AnimatedTransition>();
            ...
            for (InputPoint previousInputPoint : previousClusterPoint.getPointsInCluster()) {
              if (currentClusterPoint.containsInputPoint(previousInputPoint)) {
                ...
                if (transition != null) {
                  ...
                  transition =
                      new AnimatedTransition(projection, previousClusterPoint, previousInputPoint,
                          currentClusterPoint);
