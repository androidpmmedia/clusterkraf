...
public class Clusterkraf {
  ...
  public Clusterkraf(GoogleMap map, Options options, ArrayList<InputPoint> points) {
    ...
    this.transitionsAnimation =
        new ClusterTransitionsAnimation(map, options, innerCallbackListener);
  ...
  public void zoomToBounds(ClusterPoint clusterPoint) {
    ...
    if (map != null && clusterPoint != null) {
      ...
      CameraUpdate cameraUpdate =
          CameraUpdateFactory.newLatLngBounds(clusterPoint.getBoundsOfInputPoints(),
              options.getZoomToBoundsPadding());
  ...
  private static class InnerCallbackListener
      ...
      OnMarkerClickListener, OnInfoWindowClickListener, GoogleMap.InfoWindowAdapter {
    ...
    private InnerCallbackListener(Clusterkraf clusterkraf) {
      ...
      clusteringOnCameraChangeListener =
          new ClusteringOnCameraChangeListener(this, clusterkraf.options);
    }
    ...
    public boolean onMarkerClick(Marker marker) {
      ...
      if (clusterkraf != null) {
        ...
        OnMarkerClickDownstreamListener downstreamListener =
            clusterkraf.options.getOnMarkerClickDownstreamListener();
    ...
    public void onInfoWindowClick(Marker marker) {
      ...
      if (clusterkraf != null) {
        boolean handled = false;
        ClusterPoint clusterPoint = clusterkraf.currentClusterPointsByMarker.get(marker);
        OnInfoWindowClickDownstreamListener downstreamListener =
            clusterkraf.options.getOnInfoWindowClickDownstreamListener();
    ...
    public View getInfoWindow(Marker marker) {
      ...
      if (clusterkraf != null) {
        ...
        InfoWindowDownstreamAdapter infoWindowDownstreamAdapter =
            clusterkraf.options.getInfoWindowDownstreamAdapter();
