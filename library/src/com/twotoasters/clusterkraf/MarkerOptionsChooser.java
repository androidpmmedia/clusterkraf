...
public abstract class MarkerOptionsChooser {
   ...
   * ClusterPoint
   *
   * @param markerOptions The MarkerOptions object which will be used to add the Marker
   * @param clusterPoint The ClusterPoint object representing the InputPoint objects
