...
public class Options {
   ...
   */
  private ClusterInfoWindowClickBehavior clusterInfoWindowClickBehavior =
      ClusterInfoWindowClickBehavior.HIDE_INFO_WINDOW;

  /**
   * The behavior when a single point's marker is clicked
   */
  private SinglePointClickBehavior singlePointClickBehavior =
      SinglePointClickBehavior.SHOW_INFO_WINDOW;

  /**
   * The behavior when a single point's info window is clicked
   */
  private SinglePointInfoWindowClickBehavior singlePointInfoWindowClickBehavior =
      SinglePointInfoWindowClickBehavior.HIDE_INFO_WINDOW;
  ...
  /**
   * @param transitionInterpolator the transitionInterpolator to set
   */
  ...
  /**
   * @param pixelDistanceToJoinCluster the pixelDistanceToJoinCluster to set. This value should be
  ...
  /**
   * @param onMarkerClickDownstreamListener the onMarkerClickDownstreamListener to set
   */
  public void setOnMarkerClickDownstreamListener(
  ...
  /**
   * @param onInfoWindowClickDownstreamListener the onInfoWindowClickDownstreamListener to set
   */
  public void setOnInfoWindowClickDownstreamListener(
      OnInfoWindowClickDownstreamListener onInfoWindowClickDownstreamListener) {
  ...
  /**
   * @param infoWindowDownstreamAdapter the infoWindowDownstreamAdapter to set
   */
  public void setInfoWindowDownstreamAdapter(
      InfoWindowDownstreamAdapter infoWindowDownstreamAdapter) {
  ...
  /**
   * @param clusterClickBehavior the clusterClickBehavior to set
   */
  ...
  /**
   * @param clusterInfoWindowClickBehavior the clusterInfoWindowClickBehavior to set
   */
  public void setClusterInfoWindowClickBehavior(
      ClusterInfoWindowClickBehavior clusterInfoWindowClickBehavior) {
  ...
  /**
   * @param zoomToBoundsPadding the zoomToBoundsPadding to set
   */
  ...
  /**
   * @param zoomToBoundsAnimationDuration the zoomToBoundsAnimationDuration to set
   */
  ...
  /**
   * @param showInfoWindowAnimationDuration the showInfoWindowAnimationDuration to set
   */
  ...
  /**
   * @param singlePointClickBehavior the singlePointClickBehavior to set
   */
  ...
  /**
   * @param singlePointInfoWindowClickBehavior the singlePointInfoWindowClickBehavior to set
   */
  public void setSinglePointInfoWindowClickBehavior(
      SinglePointInfoWindowClickBehavior singlePointInfoWindowClickBehavior) {
   ...
   */
  public void setClusteringOnCameraChangeListenerDirtyLifetimeMillis(
      long clusteringOnCameraChangeListenerDirtyLifetimeMillis) {
    this.clusteringOnCameraChangeListenerDirtyLifetimeMillis =
        clusteringOnCameraChangeListenerDirtyLifetimeMillis;
  }
